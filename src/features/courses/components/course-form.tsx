...
export function CourseForm<T extends CourseFormInput>({
    ...
    return (
        <form onSubmit={onSubmit} className="flex flex-col gap-8">
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            ...
                            <Input {...field} value={field.value as string} id={field.name} placeholder="Nombre del curso" />
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid} className="lg:col-span-2">
                            ...
                            <Textarea {...field} value={field.value as string} id={field.name} placeholder="Descripción corta del curso" />
                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                        </Field>
                    )}
                />
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            ...
                            <Input {...field} value={field.value as number} id={field.name} type="number" min={0} step="0.01" />
                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                        </Field>
                    )}
                />
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            ...
                            <Input
                                id={field.name}
                                type="datetime-local"
                                value={field.value instanceof Date ? getCourseDateTimeLocalValue(field.value) : ""}
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            ...
                            <Input {...field} value={field.value as string} id={field.name} placeholder="4 semanas" />
                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                        </Field>
                    )}
                />
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            ...
                            <Input {...field} value={field.value as number} id={field.name} type="number" min={1} />
                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                        </Field>
                    )}
                />
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            ...
                            <Input {...field} value={field.value as string} id={field.name} placeholder="https://wa.me/..." />
                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                        </Field>
                    )}
                />
            ...
            <div className="grid gap-4 rounded-lg border p-4 lg:grid-cols-[220px_1fr]">
                    ...
                    <Controller
                        ...
                        render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                                ...
                                <Input {...field} value={field.value as string} id={field.name} placeholder="https://..." />
                                {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                            </Field>
                        )}
                    />
            ...
            <section className="space-y-4">
                <div className="flex items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Agrega el contenido principal del curso.</p>
                    </div>
                    <Button
                        type="button"
                        variant="outline"
                            ...
                            <div className="grid gap-4 lg:grid-cols-[1fr_120px]">
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field data-invalid={fieldState.invalid}>
                                            <FieldLabel htmlFor={field.name}>Título {requiredMark}</FieldLabel>
                                            <Input {...field} value={field.value as string} id={field.name} placeholder="Introducción" />
                                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                                        </Field>
                                    )}
                                />
                                ...
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field data-invalid={fieldState.invalid} className="lg:col-span-2">
                                            <FieldLabel htmlFor={field.name}>Resumen {requiredMark}</FieldLabel>
                                            <Textarea {...field} value={field.value as string} id={field.name} placeholder="Qué se aprende en este módulo" />
                                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                                        </Field>
                                    )}
                                />
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field data-invalid={fieldState.invalid} className="lg:col-span-2">
                                            ...
                                            <Textarea {...field} value={field.value as string} id={field.name} placeholder="Temas, clases o recursos" className="min-h-24" />
                                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                                        </Field>
                                    )}
                                />
